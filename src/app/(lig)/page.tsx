    ...
    <>
      ...
      >
        <div className="layout-container flex h-full grow flex-col">
          <div className="bg-cover bg-center md:px-40 flex flex-1 justify-center md:py-5">
              ...
              <div className="flex flex-col gap-10 px-4 py-10 @container">
                <div className="flex flex-col gap-4">
                  ...
                  <p className="text-[#0e141b] text-base font-normal leading-normal max-w-[720px]">
                    ...
                    painting, interior or exterior painting, or cabinet
                    painting, we can help. Our team of professional painters
                    will work with you to create a beautiful, long-lasting
                ...
                <div className="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3">
                  <div className="flex flex-col gap-3 pb-3">
                    ...
                    <div>
                      ...
                      <p className="text-[#4e7397] text-sm font-normal leading-normal">
                        ...
                        painted or your entire home, our team of professionals
                  ...
                  <div className="flex flex-col gap-3 pb-3">
                    ...
                    <div>
                      ...
                      <p className="text-[#4e7397] text-sm font-normal leading-normal">
                        We offer interior painting services for homeowners in
                        the area. Whether you need a single room painted or your
                  ...
                  <div className="flex flex-col gap-3 pb-3">
                    ...
                    <div>
                      ...
                      <p className="text-[#4e7397] text-sm font-normal leading-normal">
                        We offer exterior painting services for homeowners in
                        the area. Whether you need a single room painted or your
                        entire home, our team of professionals can handle any
                        project.
                      </p>
